...
int main() {
    std::vector<int> arr = { 98, 65, 35, 35, 16, 89, 9, 9 };
    std::cout<<"Before: "; merge_518307ahis::print(arr);
    merge_518307ahis::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_518307ahis::print(arr);
    return 0;
}
