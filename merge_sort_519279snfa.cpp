...
int main() {
    std::vector<int> arr = { 24, 11, 37, 5, 97, 54, 2, 79 };
    std::cout<<"Before: "; merge_519279snfa::print(arr);
    merge_519279snfa::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_519279snfa::print(arr);
    return 0;
}
