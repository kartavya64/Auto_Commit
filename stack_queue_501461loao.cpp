...
int main() {
    ds_501461loao::Stack<int> stk;
    for(int x:{ 40, 38, 62, 33, 22, 72, 85, 14, 38 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_501461loao::CQueue<int> q(20);
    for(int x:{ 40, 38, 62, 33, 22, 72, 85, 14, 38 }) q.enqueue(x);
