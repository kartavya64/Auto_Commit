...
int main() {
    ds_508357rxbl::Stack<int> stk;
    for(int x:{ 78, 37, 66, 40, 87, 97, 3, 98 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_508357rxbl::CQueue<int> q(20);
    for(int x:{ 78, 37, 66, 40, 87, 97, 3, 98 }) q.enqueue(x);
