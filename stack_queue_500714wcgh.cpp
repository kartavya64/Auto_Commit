...
int main() {
    ds_500714wcgh::Stack<int> stk;
    for(int x:{ 59, 74, 53, 35, 54, 70, 96 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_500714wcgh::CQueue<int> q(20);
    for(int x:{ 59, 74, 53, 35, 54, 70, 96 }) q.enqueue(x);
