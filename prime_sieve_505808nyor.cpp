...
int main() {
    auto primes=primes_505808nyor::sieve(30);
    std::cout<<"Primes up to 30: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=15*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_505808nyor::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
