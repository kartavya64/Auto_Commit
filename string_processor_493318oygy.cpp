...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_493318oygy::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_493318oygy::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_493318oygy::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
