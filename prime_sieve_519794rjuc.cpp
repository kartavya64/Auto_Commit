...
int main() {
    auto primes=primes_519794rjuc::sieve(33);
    std::cout<<"Primes up to 33: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=8*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_519794rjuc::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
