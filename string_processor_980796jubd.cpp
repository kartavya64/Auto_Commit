// Auto-generated: 2026-05-11 18:56:20
...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_980796jubd::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_980796jubd::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_980796jubd::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
