...
int main() {
    auto primes=primes_501956qdxk::sieve(35);
    std::cout<<"Primes up to 35: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=8*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_501956qdxk::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
