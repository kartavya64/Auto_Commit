...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_499601tcdz::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_499601tcdz::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_499601tcdz::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
