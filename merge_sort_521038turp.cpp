...
int main() {
    std::vector<int> arr = { 57, 78, 81, 62, 95, 16, 48, 29 };
    std::cout<<"Before: "; merge_521038turp::print(arr);
    merge_521038turp::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_521038turp::print(arr);
    return 0;
}
