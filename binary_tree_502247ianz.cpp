...
int main() {
    std::shared_ptr<bst_502247ianz::Node> root;
    for(int x:{ 3, 6, 43, 74, 3, 43, 98 }) root=bst_502247ianz::insert(root,x);
    std::cout<<"Inorder:     "; bst_502247ianz::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_502247ianz::level_order(root); std::cout<<"\n";
    return 0;
}
