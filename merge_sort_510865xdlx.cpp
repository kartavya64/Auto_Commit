...
int main() {
    std::vector<int> arr = { 36, 26, 2, 42, 29, 22 };
    std::cout<<"Before: "; merge_510865xdlx::print(arr);
    merge_510865xdlx::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_510865xdlx::print(arr);
    return 0;
}
