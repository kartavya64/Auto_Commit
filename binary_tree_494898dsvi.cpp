...
int main() {
    std::shared_ptr<bst_494898dsvi::Node> root;
    for(int x:{ 26, 32, 55, 37, 16, 64, 14, 52, 57 }) root=bst_494898dsvi::insert(root,x);
    std::cout<<"Inorder:     "; bst_494898dsvi::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_494898dsvi::level_order(root); std::cout<<"\n";
    return 0;
}
