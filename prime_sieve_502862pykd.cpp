...
int main() {
    auto primes=primes_502862pykd::sieve(37);
    std::cout<<"Primes up to 37: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=15*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_502862pykd::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
