...
int main() {
    auto primes=primes_508635krgm::sieve(43);
    std::cout<<"Primes up to 43: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=8*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_508635krgm::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
