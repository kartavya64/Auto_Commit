...
int main() {
    auto primes=primes_509323olad::sieve(48);
    std::cout<<"Primes up to 48: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=8*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_509323olad::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
