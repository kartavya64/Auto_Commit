...
int main() {
    std::vector<int> arr = { 48, 47, 6, 87, 85, 87 };
    std::cout<<"Before: "; merge_500987cmce::print(arr);
    merge_500987cmce::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_500987cmce::print(arr);
    return 0;
}
