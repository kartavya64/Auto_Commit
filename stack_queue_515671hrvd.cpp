...
int main() {
    ds_515671hrvd::Stack<int> stk;
    for(int x:{ 41, 90, 56, 24, 7, 69, 39 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_515671hrvd::CQueue<int> q(20);
    for(int x:{ 41, 90, 56, 24, 7, 69, 39 }) q.enqueue(x);
