...
int main() {
    std::shared_ptr<bst_498721sbnx::Node> root;
    for(int x:{ 10, 85, 16, 30, 84, 34, 94, 97, 12 }) root=bst_498721sbnx::insert(root,x);
    std::cout<<"Inorder:     "; bst_498721sbnx::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_498721sbnx::level_order(root); std::cout<<"\n";
    return 0;
}
