...
int main() {
    auto primes=primes_502729chdr::sieve(39);
    std::cout<<"Primes up to 39: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=14*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_502729chdr::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
