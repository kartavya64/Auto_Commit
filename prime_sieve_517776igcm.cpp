...
int main() {
    auto primes=primes_517776igcm::sieve(59);
    std::cout<<"Primes up to 59: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=9*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_517776igcm::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
