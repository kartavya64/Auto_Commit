...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_507085sphj::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_507085sphj::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_507085sphj::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
