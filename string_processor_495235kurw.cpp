...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_495235kurw::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_495235kurw::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_495235kurw::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
