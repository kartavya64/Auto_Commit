...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_504841vqwh::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_504841vqwh::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_504841vqwh::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
