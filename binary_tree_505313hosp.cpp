...
int main() {
    std::shared_ptr<bst_505313hosp::Node> root;
    for(int x:{ 41, 7, 67, 8, 53, 45, 21, 50, 2 }) root=bst_505313hosp::insert(root,x);
    std::cout<<"Inorder:     "; bst_505313hosp::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_505313hosp::level_order(root); std::cout<<"\n";
    return 0;
}
