// Auto-generated: 2026-05-11 18:48:22
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_502116gway {
...
int main() {
    std::shared_ptr<bst_502116gway::Node> root;
    for(int x:{ 76, 38, 54, 83, 90, 68, 89, 20 }) root=bst_502116gway::insert(root,x);
    std::cout<<"Inorder:     "; bst_502116gway::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_502116gway::level_order(root); std::cout<<"\n";
    return 0;
}
