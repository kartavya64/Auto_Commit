...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_505029cpuu::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_505029cpuu::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_505029cpuu::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
