...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_492390vujm::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_492390vujm::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_492390vujm::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
