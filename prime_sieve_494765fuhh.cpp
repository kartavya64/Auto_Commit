...
int main() {
    auto primes=primes_494765fuhh::sieve(51);
    std::cout<<"Primes up to 51: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=11*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_494765fuhh::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
