...
int main() {
    std::vector<int> arr = { 92, 5, 55, 52, 89, 55 };
    std::cout<<"Before: "; merge_496917rkxz::print(arr);
    merge_496917rkxz::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_496917rkxz::print(arr);
    return 0;
}
