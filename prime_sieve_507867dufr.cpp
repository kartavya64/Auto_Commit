...
int main() {
    auto primes=primes_507867dufr::sieve(40);
    std::cout<<"Primes up to 40: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=10*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_507867dufr::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
