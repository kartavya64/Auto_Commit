...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_494491abqf::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_494491abqf::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_494491abqf::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
