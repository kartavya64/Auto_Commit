...
int main() {
    auto primes=primes_508497tysf::sieve(41);
    std::cout<<"Primes up to 41: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=10*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_508497tysf::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
