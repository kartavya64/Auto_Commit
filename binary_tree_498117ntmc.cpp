...
int main() {
    std::shared_ptr<bst_498117ntmc::Node> root;
    for(int x:{ 28, 5, 77, 43, 6, 84, 18 }) root=bst_498117ntmc::insert(root,x);
    std::cout<<"Inorder:     "; bst_498117ntmc::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_498117ntmc::level_order(root); std::cout<<"\n";
    return 0;
}
