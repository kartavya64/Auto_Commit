...
int main() {
    ds_511820sthx::Stack<int> stk;
    for(int x:{ 18, 20, 93, 79, 61, 42 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_511820sthx::CQueue<int> q(20);
    for(int x:{ 18, 20, 93, 79, 61, 42 }) q.enqueue(x);
