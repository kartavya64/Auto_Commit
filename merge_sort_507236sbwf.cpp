...
int main() {
    std::vector<int> arr = { 38, 86, 59, 44, 85, 5, 17, 99, 20 };
    std::cout<<"Before: "; merge_507236sbwf::print(arr);
    merge_507236sbwf::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_507236sbwf::print(arr);
    return 0;
}
