...
int main() {
    std::shared_ptr<bst_494058ixwn::Node> root;
    for(int x:{ 47, 82, 21, 24, 55, 9, 93 }) root=bst_494058ixwn::insert(root,x);
    std::cout<<"Inorder:     "; bst_494058ixwn::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_494058ixwn::level_order(root); std::cout<<"\n";
    return 0;
}
