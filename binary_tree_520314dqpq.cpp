// Auto-generated: 2026-05-11 18:48:40
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_520314dqpq {
...
int main() {
    std::shared_ptr<bst_520314dqpq::Node> root;
    for(int x:{ 55, 45, 57, 78, 73, 3, 46, 57, 82 }) root=bst_520314dqpq::insert(root,x);
    std::cout<<"Inorder:     "; bst_520314dqpq::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_520314dqpq::level_order(root); std::cout<<"\n";
    return 0;
}
