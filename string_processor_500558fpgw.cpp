...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_500558fpgw::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_500558fpgw::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_500558fpgw::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
