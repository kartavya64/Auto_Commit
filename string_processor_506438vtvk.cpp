...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_506438vtvk::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_506438vtvk::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_506438vtvk::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
