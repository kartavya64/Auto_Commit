...
int main() {
    std::vector<int> arr = { 10, 29, 41, 29, 75, 51 };
    std::cout<<"Before: "; merge_510658ckjk::print(arr);
    merge_510658ckjk::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_510658ckjk::print(arr);
    return 0;
}
