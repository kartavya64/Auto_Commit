...
int main() {
    std::vector<int> arr = { 91, 54, 31, 58, 16, 9 };
    std::cout<<"Before: "; merge_520156lhfb::print(arr);
    merge_520156lhfb::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_520156lhfb::print(arr);
    return 0;
}
