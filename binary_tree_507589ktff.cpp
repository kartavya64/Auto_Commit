// Auto-generated: 2026-05-11 18:48:27
// Topic: Binary Search Tree — Insert, Search, Traversal
#include <iostream>
#include <memory>
#include <queue>

namespace bst_507589ktff {
...
int main() {
    std::shared_ptr<bst_507589ktff::Node> root;
    for(int x:{ 37, 33, 72, 75, 99, 29, 52, 46, 97, 22 }) root=bst_507589ktff::insert(root,x);
    std::cout<<"Inorder:     "; bst_507589ktff::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_507589ktff::level_order(root); std::cout<<"\n";
    return 0;
}
