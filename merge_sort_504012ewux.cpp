...
int main() {
    std::vector<int> arr = { 47, 51, 16, 88, 26, 31, 64, 13, 46, 40 };
    std::cout<<"Before: "; merge_504012ewux::print(arr);
    merge_504012ewux::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_504012ewux::print(arr);
    return 0;
}
