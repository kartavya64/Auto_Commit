...
int main() {
    ds_516473uahq::Stack<int> stk;
    for(int x:{ 46, 29, 52, 21, 8, 15, 7, 91 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_516473uahq::CQueue<int> q(20);
    for(int x:{ 46, 29, 52, 21, 8, 15, 7, 91 }) q.enqueue(x);
