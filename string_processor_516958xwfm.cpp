...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_516958xwfm::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_516958xwfm::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_516958xwfm::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
