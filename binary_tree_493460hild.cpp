...
int main() {
    std::shared_ptr<bst_493460hild::Node> root;
    for(int x:{ 74, 5, 16, 82, 43, 76, 90, 21, 96, 19 }) root=bst_493460hild::insert(root,x);
    std::cout<<"Inorder:     "; bst_493460hild::inorder(root); std::cout<<"\n";
    std::cout<<"Level order: "; bst_493460hild::level_order(root); std::cout<<"\n";
    return 0;
}
