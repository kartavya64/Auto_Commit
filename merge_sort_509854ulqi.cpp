...
int main() {
    std::vector<int> arr = { 71, 27, 84, 3, 16, 17, 59 };
    std::cout<<"Before: "; merge_509854ulqi::print(arr);
    merge_509854ulqi::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_509854ulqi::print(arr);
    return 0;
}
