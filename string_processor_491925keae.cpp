...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_491925keae::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_491925keae::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_491925keae::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
