...
int main() {
    ds_494306larn::Stack<int> stk;
    for(int x:{ 58, 8, 52, 87, 24, 88, 49 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_494306larn::CQueue<int> q(20);
    for(int x:{ 58, 8, 52, 87, 24, 88, 49 }) q.enqueue(x);
