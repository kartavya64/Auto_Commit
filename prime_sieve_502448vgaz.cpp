...
int main() {
    auto primes=primes_502448vgaz::sieve(38);
    std::cout<<"Primes up to 38: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=13*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_502448vgaz::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
