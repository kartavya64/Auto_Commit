...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_520871sfao::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_520871sfao::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_520871sfao::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
