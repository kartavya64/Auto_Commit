...
int main() {
    std::vector<int> arr = { 27, 16, 56, 26, 46, 44 };
    std::cout<<"Before: "; merge_511974tznd::print(arr);
    merge_511974tznd::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_511974tznd::print(arr);
    return 0;
}
