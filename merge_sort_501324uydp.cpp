...
int main() {
    std::vector<int> arr = { 4, 49, 71, 50, 6, 60, 58, 45 };
    std::cout<<"Before: "; merge_501324uydp::print(arr);
    merge_501324uydp::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_501324uydp::print(arr);
    return 0;
}
