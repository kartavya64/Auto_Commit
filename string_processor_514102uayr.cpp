...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_514102uayr::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_514102uayr::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_514102uayr::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
