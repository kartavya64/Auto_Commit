...
int main() {
    auto primes=primes_498862hlfc::sieve(55);
    std::cout<<"Primes up to 55: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=12*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_498862hlfc::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
