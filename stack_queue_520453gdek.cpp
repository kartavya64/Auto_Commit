...
int main() {
    ds_520453gdek::Stack<int> stk;
    for(int x:{ 30, 79, 64, 95, 24, 57 }) stk.push(x);
    std::cout<<"Stack top: "<<stk.peek()<<" size: "<<stk.size()<<"\n";
    ds_520453gdek::CQueue<int> q(20);
    for(int x:{ 30, 79, 64, 95, 24, 57 }) q.enqueue(x);
