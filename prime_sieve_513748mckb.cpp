...
int main() {
    auto primes=primes_513748mckb::sieve(53);
    std::cout<<"Primes up to 53: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=14*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_513748mckb::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
