...
int main() {
    auto primes=primes_513459alkq::sieve(46);
    std::cout<<"Primes up to 46: "; for(int p:primes) std::cout<<p<<" "; std::cout<<"\n";
    int n=12*7;
    std::cout<<"Factors of "<<n<<": ";
    for(int f:primes_513459alkq::factorize(n)) std::cout<<f<<" "; std::cout<<"\n";
    return 0;
}
