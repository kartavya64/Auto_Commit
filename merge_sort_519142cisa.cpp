...
int main() {
    std::vector<int> arr = { 72, 17, 1, 1, 41, 14, 10, 59, 48, 90 };
    std::cout<<"Before: "; merge_519142cisa::print(arr);
    merge_519142cisa::sort(arr,0,arr.size()-1);
    std::cout<<"After:  "; merge_519142cisa::print(arr);
    return 0;
}
