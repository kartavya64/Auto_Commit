...
int main() {
    ...
    std::cout<<"Original:  "<<s<<"\n";
    std::cout<<"Upper:     "<<str_518630bibt::upper(s)<<"\n";
    std::cout<<"Reversed:  "<<str_518630bibt::reverse_words(s)<<"\n";
    std::cout<<"Palindrome check 'racecar': "<<(str_518630bibt::palindrome("racecar")?"yes":"no")<<"\n";
    return 0;
}
